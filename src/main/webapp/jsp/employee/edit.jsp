    ...
    <form action="/employees/edit" method="post" class="container">
        <div class="row">
            <div class="input-field col s6">
                ...
                <input id="first_name" type="text" class="validate" name="first_name" value="${employee.firstName}"
                       required>
                <label for="first_name">Imię</label>
            </div>
            <div class="input-field col s6">
                <input id="last_name" type="text" class="validate" name="last_name" value="${employee.lastName}"
                       required>
        ...
        <div class="row">
            <div class="input-field col s12">
                ...
                <input id="telephone" type="text" class="validate" name="telephone" value="${employee.telephone}"
                       pattern="\+?[0-9 ]{1,19}">
